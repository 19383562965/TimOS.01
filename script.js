...
wallpaper.onclick = function() {body.style.backgroundImage = "url('images/wallpapers/background.jpg')"}
wallpaperOne.onclick = function() {body.style.backgroundImage = "url('images/wallpapers/background_one.jpg')"}
wallpaperTwo.onclick = function() {body.style.backgroundImage = "url('images/wallpapers/background_two.jpg')"}
wallpaperThree.onclick = function() {body.style.backgroundImage = "url('images/wallpapers/background_three.jpg')"}
wallpaperFour.onclick = function() {body.style.backgroundImage = "url('images/wallpapers/background_four.jpg')"}
wallpaperFive.onclick = function() {body.style.backgroundImage = "url('images/wallpapers/background_five.jpg')"}
wallpaperSix.onclick = function() {body.style.backgroundImage = "url('images/wallpapers/background_six.jpg')"}
wallpaperSeven.onclick = function() {body.style.backgroundImage = "url('images/wallpapers/background_seven.jpg')"}
wallpaperEight.onclick = function() {body.style.backgroundImage = "url('images/wallpapers/background_eight.jpg')"}
wallpaperNine.onclick = function() {body.style.backgroundImage = "url('images/wallpapers/background_nine.jpg')"}
...
window.addEventListener("load", function () {
  ...
  if (loadingAnimation) {
    setTimeout(() => {
      ...
      body.style.backgroundImage = "url('images/wallpapers/background_three.jpg')"
    }, 5000);
  }
...
reloadBtn.addEventListener("click", () => {
  body.style.backgroundImage = "url('images/wallpapers/background.jpg')"
  const loadingAnimation = document.getElementById("loading-animation");
...
blurBtn.onclick = function() {
  if(body.style.backdropFilter === "blur(100px)") {
